...
<div align="center">
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/D1se0/D1se0/output/github-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/D1se0/D1se0/output/github-snake.svg" />
  <img alt="Snake eating my contributions" src="https://raw.githubusercontent.com/D1se0/D1se0/output/github-snake.svg" />
</picture>
</div>
  ...
  <tr>
    <td align="center" width="50%">
      ...
      <a href="https://d1se0.github.io/blog_hacking/">
        <img src="https://raw.githubusercontent.com/D1se0/blog_hacking/v2/favicon.png" alt="Blog Hacking" style="width: 100%; height: 120px; border-radius: 20px; margin: 12px 0;">
      </a>
    ...
    <td align="center" width="50%">
      ...
      <a href="https://d1se0.github.io/hackerlabs/">
        <img src="https://github.com/user-attachments/assets/25ee94f6-ac12-4134-b5b0-540600ea28f3" alt="HackerLabs Website" style="width: 100%; max-height: 200px; border-radius: 8px;">
      </a>
...
| Herramienta | Repo |
|---|---|
| portScan | [D1se0/portScan](https://github.com/D1se0/portScan/tree/main) |
| enumPluginsWordpress | [D1se0/enumPluginsWordpress](https://github.com/D1se0/enumPluginsWordpress/tree/main) |
| PHPDetector | [D1se0/PHPDetector-page](https://github.com/D1se0/PHPDetector-page) |
| WiFiHackWPA2-3 | [D1se0/WiFiHackWPA2-3](https://github.com/D1se0/WiFiHackWPA2-3) |
| DetectorAPFisico (Gadget) | [D1se0/DetectorAPFisico-Gadget-Hacking](https://github.com/D1se0/DetectorAPFisico-Gadget-Hacking/tree/main) |

</details>

<details>
<summary><b>🔑 Passwords &amp; Bruteforce</b></summary>
<br/>

| Herramienta | Repo |
|---|---|
| suBruteforce | [D1se0/suBruteforce](https://github.com/D1se0/suBruteforce) |
| passwordGenerator | [D1se0/passwordGenerator](https://github.com/D1se0/passwordGenerator) |
| checkPassword | [D1se0/checkPassword](https://github.com/D1se0/checkPassword) |
| crackerPass | [D1se0/crackerPass](https://github.com/D1se0/crackerPass/tree/main) |
| brutePSWA | [D1se0/brutePSWA](https://github.com/D1se0/brutePSWA/tree/main) |
| Gestor de contraseñas App (BETA) | [D1se0/Aplicacion_Gestor_de_contrasenas_Windows](https://github.com/D1se0/Aplicacion_Gestor_de_contrasenas_Windows) |

</details>

<details>
<summary><b>💥 Exploitation &amp; CVE Labs</b></summary>
<br/>

| Herramienta | Repo |
|---|---|
| Bypass-MFA-Wordpress-LAB | [CVE-2024-10924](https://github.com/D1se0/CVE-2024-10924-Bypass-MFA-Wordpress-LAB/tree/main) |
| Vulnerabilidad-Outlook-LAB | [CVE-2024-21413](https://github.com/D1se0/CVE-2024-21413-Vulnerabilidad-Outlook-LAB/tree/main) |
| Vulnerabilidad-Jenkins-LAB | [CVE-2024-23897](https://github.com/D1se0/CVE-2024-23897-Vulnerabilidad-Jenkins) |
| PoC - CVE-2024-51428 | [D1se0/CVE-2024-51428-PoC](https://github.com/D1se0/CVE-2024-51428-PoC) |
| Eloquia DLL Injection Exploit (HTB) | [D1se0/Eloquia-DLL-Injection-Exploit-HTB](https://github.com/D1se0/Eloquia-DLL-Injection-Exploit-HTB) |

</details>

<details>
<summary><b>🕵️ Post-Exploitation &amp; Red Team</b></summary>
<br/>

| Herramienta | Repo |
|---|---|
| revShell | [D1se0/revShell](https://github.com/D1se0/revShell) |
| Rev Shell's Generator | [D1se0/revShellsGenerator-page](https://github.com/D1se0/revShellsGenerator-page) |
| keylogger_script | [D1se0/keylogger_script](https://github.com/D1se0/keylogger_script/tree/main) |
| InterceptPassResetWindows | [D1se0/InterceptPassResetWindows](https://github.com/D1se0/InterceptPassResetWindows) |
| WinFind | [D1se0/winFind](https://github.com/D1se0/winFind/tree/main) |
| C2-Panel-Malware-Education | [D1se0/c2-panel-malware-education](https://github.com/D1se0/c2-panel-malware-education/tree/main) |
| RansomwareLocker (Education) | [D1se0/RansomwareLocker_Education](https://github.com/D1se0/RansomwareLocker_Education/tree/main) |
| EnvObfuscatorPS | [D1se0/EnvObfuscatorPS](https://github.com/D1se0/EnvObfuscatorPS/tree/main) |
| PSHelp | [D1se0/PSHelp](https://github.com/D1se0/PSHelp) |
| SpoofingApp | [D1se0/SpoofingApp](https://github.com/D1se0/SpoofingApp/tree/main) |

</details>

<details>
<summary><b>🌐 Networking &amp; Calculadoras</b></summary>
<br/>

| Herramienta | Repo |
|---|---|
| internetNullHacker | [D1se0/internetNullHacker](https://github.com/D1se0/internetNullHacker) |
| advancedInternetNullHacker | [D1se0/advancedInternetNullHacker](https://github.com/D1se0/advancedInternetNullHacker/tree/main) |
| dynamicIPTool | [D1se0/dynamicIPTool](https://github.com/D1se0/dynamicIPTool) |
| Calculadora de Subnetting | [D1se0/calculadora_subnetting](https://github.com/D1se0/calculadora_subnetting) |
| Calculadora de VLSM | [D1se0/calculadora_vlsm](https://github.com/D1se0/calculadora_vlsm) |
| Calculadora CHMOD | [D1se0/chmod-calculator](https://github.com/D1se0/chmod-calculator) |

</details>

<details>
<summary><b>⚙️ Entornos &amp; Setup</b></summary>
<br/>

| Herramienta | Repo |
|---|---|
| Kali-environment-install | [D1se0/kali-environment-install](https://github.com/D1se0/kali-environment-install) |
| toolsKitHacking | [D1se0/toolsKitHacking](https://github.com/D1se0/toolsKitHacking) |
| Arch i3 - d1se0 Environment | [D1se0/Arch_i3_d1se0_Environment](https://github.com/D1se0/Arch_i3_d1se0_Environment) |
| Entorno Nordico Kali Linux | [D1se0/environment-kali-nordic](https://github.com/D1se0/environment-kali-nordic) |

</details>

<details>
<summary><b>🚩 CTF, Labs &amp; Misc</b></summary>
<br/>

| Herramienta | Repo |
|---|---|
| hackerlabsCtfs-tool | [D1se0/hackerlabsCtfs-tool](https://github.com/D1se0/hackerlabsCtfs-tool/tree/main) |
| CheatSheet Maquinas HTB | [D1se0/cheatsheet_machines_htb](https://github.com/D1se0/cheatsheet_machines_htb) |
| superTool | [D1se0/superTool](https://github.com/D1se0/superTool/tree/main) |
| Cerbero | [D1se0/cerbero](https://github.com/D1se0/cerbero) |
| Command Vault (BETA) | [D1se0/Command_Vault](https://github.com/D1se0/Command_Vault) |
| LogsGenerator | [D1se0/logsGenerator](https://github.com/D1se0/logsGenerator) |
| HackingChef | [D1se0/hackingChef-page](https://github.com/D1se0/hackingChef-page) |
...
<a href="https://www.linkedin.com/in/adriaangaarcialopez">
